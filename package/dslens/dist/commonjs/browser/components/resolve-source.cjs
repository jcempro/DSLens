...
// src/ts/browser/components/resolve-source.ts
var resolve_source_exports = {};
__export(resolve_source_exports, {
  resolveParserExpression: () => resolveParserExpression
});
module.exports = __toCommonJS(resolve_source_exports);
...
//# sourceMappingURL=resolve-source.cjs.map
