...
// src/ts/browser/components/resolve-data.ts
var resolve_data_exports = {};
__export(resolve_data_exports, {
  resolveDslData: () => resolveDslData,
  toDslResult: () => toDslResult
});
module.exports = __toCommonJS(resolve_data_exports);
...
//# sourceMappingURL=resolve-data.cjs.map
